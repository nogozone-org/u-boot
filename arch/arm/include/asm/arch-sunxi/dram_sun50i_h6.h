...
/*
 * The following infomation is mainly retrieved by disassembly and some FPGA
...
/*
 * The following register infomation are retrieved from some similar DRAM
...
/*
 * The following register infomation is based on Zynq UltraScale+
